export default function Faq() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      description: "Sim! Oferecemos um teste gratuito de 3 dias, sem compromisso. Isso permite que você explore todas as funcionalidades da nossa plataforma antes de decidir por uma assinatura."
    },
    {
