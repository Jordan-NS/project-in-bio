    ...
    <div className="my-[150px] flex flex-col items-center gap-14">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-content-body text-xl text-center">
          Junte-se a nossa comunidade de criadores profissionais que já estão elevando sua <br /> presença online. teste gratuitamente por <strong className="text-accent-pink">{TRIAL_DAYS} dias</strong>, sem compromisso.
        </p>
      </div>
      <div className="flex items-end gap-9">
        <div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xl border border-[#1E1E1E]">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-content-headline">/mês</span>
          </div>
          <Button variant="secondary">Assinar</Button>
        </div>
        <div className="flex flex-col">
          <div className="flex justify-center items-center rounded-t-2xl p-2 w-full bg-[linear-gradient(90deg,#4B2DBB_0%,#B5446B_100%)]">
          ...
          <div className="p-[1.6px] bg-[linear-gradient(90deg,#4B2DBB_0%,#B5446B_100%)] rounded-b-2xl">
            <div className="w-full bg-background-secondary p-8 flex flex-col gap-7 rounded-b-2xl">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-content-headline">/único</span>
              </div>
