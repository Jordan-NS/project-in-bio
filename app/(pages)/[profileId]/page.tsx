  ...
  return (
    <div className="relative h-screen flex p-20 overflow-hidden">
      ...
      <div className="w-full flex justify-center content-start gap-4 flex-wrap overflow-y-auto">
        ...
        <ProjectCard />
        <ProjectCard />
        <button className="w-[340px] h-[132px] rounded-[20px] bg-background-secondary flex items-center gap-2 justify-center transition-transform hover:scale-105 ease-in-out duration-300 hover:border hover:border-dashed border-border-secondary">
